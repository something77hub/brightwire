...
export default defineEventHandler(async (event) => {
  ...
  <!-- Branding -->
  <text x="${width - 60}" y="${height - 65}" font-family="Arial, 'Inter', sans-serif" font-size="32" font-weight="700" fill="white" fill-opacity="0.98" text-anchor="end" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.5)">https://brightwire.news</text>
  <text x="${width - 60}" y="${height - 20}" font-family="Arial, 'Inter', sans-serif" font-size="32" font-weight="700" fill="#F59E0B" text-anchor="end" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.5)">☀️ BrightWire</text>
</svg>`
      } else {
...
function generateSolidSvg(
  ...
  <!-- Branding -->
  <text x="${width - 60}" y="${height - 65}" font-family="Arial, 'Inter', sans-serif" font-size="32" font-weight="700" fill="#78350F" text-anchor="end">https://brightwire.news</text>
