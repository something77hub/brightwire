  ...
  <div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      ...
      <div v-else-if="showEmptyState" class="text-center py-20">
        <span class="text-5xl mb-4 block">ðŸŒ…</span>
        ...
        <div class="grid lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div v-else-if="!data?.pagination.hasMore && stories.length > 0" class="pt-8 text-center">
              <p class="text-amber-600/50 text-sm">âœ?You've seen all the stories!</p>
            </div>
          </div>
          ...
          <aside class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl p-5 text-white">
              <span class="text-3xl block mb-2">â˜€ï¸?/span>
              ...
              <div v-else class="text-center py-2">
                ...
                <p class="text-sm font-medium">{{ quickSuccessMsg || "You're in! ðŸŽ‰" }}</p>
              </div>
...
async function subscribeQuick() {
  ...
  try {
    ...
    quickSuccessMsg.value = response.message || siteSettings.value?.newsletterSuccessMessage || "You're in! ðŸŽ‰"
...
const shareJoke = () => {
  ...
  const text = `${joke}\n\nðŸ˜„ Daily good news at BrightWire`
