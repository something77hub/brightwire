...
export default defineEventHandler(async (event) => {
  ...
  <!-- Branding -->
  <text x="${width - 60}" y="${height - 50}" font-family="Arial, 'Inter', sans-serif" font-size="16" fill="white" fill-opacity="0.6" text-anchor="end">https://brightwire.news</text>
...
function generateSolidSvg(
  ...
  <!-- Branding -->
  <text x="${width - 60}" y="${height - 50}" font-family="Arial, 'Inter', sans-serif" font-size="16" fill="#9CA3AF" text-anchor="end">https://brightwire.news</text>
