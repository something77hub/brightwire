...
Don't use "good-news" unless it truly doesn't fit elsewhere.

${candidates.map((c, i) => `${i + 1}. ${c.title}`).join('\n')}

CATEGORIES - be specific:
- "heroes": People making a difference, volunteers, activists, community leaders, rescuers, donors
- "planet": Environment, wildlife, conservation, climate, sustainability, nature, oceans, forests
- "innovation": Technology, science, medicine, research, inventions, discoveries, space, AI
- "solutions": Policy wins, social programs, systemic fixes, poverty reduction, education reforms
- "good-news": ONLY for general feel-good that doesn't fit above (reunions, heartwarming moments)
